package com.davidmarcelino.workshopmongo.config;
...
import com.davidmarcelino.workshopmongo.dto.AuthorDTO;
import com.davidmarcelino.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		...
		CommentDTO c3 = new CommentDTO("Tenha um ótimo dia", sdf.parse("22/03/2023"), new AuthorDTO(alex));
